...
#property description " "
#property description "Thông số mặc định gợi ý cho BTC/USD (vốn tối thiểu: 5000 USD / 5000 cent)"
...
input double TradingStopStopBDistancePips = 200.0;  // Gồng lãi từng lệnh: khi giá cách entry X pips → đặt SL hòa vốn
